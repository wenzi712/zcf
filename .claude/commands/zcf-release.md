...
### 8. Create Release Branch and Pull Request

```bash
echo "🚀 Creating release branch and pull request..."
...
4. **Execution Phase**: Update version (automatic bump or exact version), commit changes
5. **PR Creation Phase**: Create release branch, push to remote, create pull request
6. **Review & Release Phase**: Manual PR review and merge, then GitHub Actions auto publish
