...
export async function updatePromptOnly(
  ...
  // Note: copyConfigFiles with onlyMd=true now does nothing as memory files are no longer copied
  // CLAUDE.md will be generated by applyAiLanguageDirective and configureOutputStyle below
