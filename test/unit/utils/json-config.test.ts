  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    describe('readJsonConfig edge cases', () => {
      it('should handle validation failure with ZCF config', () => {
        ...
        expect(console.warn).toHaveBeenCalledWith(expect.stringContaining('配置无效'));
      });
      ...
      it('should handle validation failure without ZCF config', () => {
        ...
        expect(result).toEqual({ default: true });
        expect(console.warn).toHaveBeenCalledWith(expect.stringContaining('Invalid configuration'));
      });
